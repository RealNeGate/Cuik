...
TknType classify_ident(const unsigned char* restrict str, size_t len) {
	...
	const static uint32_t keys[64] = {
		...
		0x74654C5F,0x7469DFD6,0x7572E8D6,0x7574D3E4,0xC2DC2C38,0xC6D8D8EA,0xCDD8DCDC,0xCFDBAFC6,
		0xD1CEB9C4,0xD9E3DDCC,0xDBCCD9E5,0xDCCDAFC6,0xE0D4C32F,0xE4E4C332,0xE5D4AFCF,0xE8D6CEE4,
		0xFFFFFFFF,0xFFFFFFFF,0xFFFFFFFF,0xFFFFFFFF,0xFFFFFFFF,0xFFFFFFFF,0xFFFFFFFF,0xFFFFFFFF,
		0xFFFFFFFF,0xFFFFFFFF,0xFFFFFFFF,0xFFFFFFFF,0xFFFFFFFF,0xFFFFFFFF,0xFFFFFFFF,0xFFFFFFFF,
		
	};
	const static uint32_t values[64] = {
		15,7,13,17,44,45,1,12,42,6,8,31,47,2,9,11,24,28,18,16,33,10,23,29,37,14,0,36,3,22,4,25,41,27,26,21,40,32,30,35,39,5,19,34,46,43,38,20,
	};
